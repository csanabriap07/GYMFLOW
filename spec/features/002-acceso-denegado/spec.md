...
- [ ] Dado un miembro con membresía **vencida** (hoy > `fecha_vencimiento`) o `visitas_restantes = 0`, cuando intenta check-in, entonces el resultado es **Denegado**, semáforo rojo, con motivo claro según el mensaje objetivo de arriba (RN-01 inversa).
